...
<style>
	...
	#submit {background-color: #439A97; color:white; border: none; width:110px; height: 40px;
...
<body>
	...
	<form>
		<div class="area">
			...
			<textarea cols="93" rows="10" style="resize:none;" placeholder="내용을 입력해주세요"></textarea><br><br>
